...
class TeamSpider(scrapy.Spider): 
    name = "cyberjawarainternational"
    def start_requests(self):
        urls = [
            "file:///ctfd/ctfd/spiders/cyberjawarainternational.html",
            ]
        for url in urls:
...
#table.xpath(td[1]//a/@href").get()
    ...
    def parse(self, response):
        ...
        df.to_csv(Path(__file__).parent / 'cyberjawarainternational.csv',index=False)
